...
import space.catpaw.Tool.PackageExplorer;
import space.catpaw.WebSocket.WebSocketEvent;
import java.io.File;
...
public abstract class Common implements JsonTools{
    ...
    protected static space.catpaw.Controller.Http.ControllerNotFound 
            httpControllerNotFound = new 
            space.catpaw.Controller.Http.ControllerNotFound();
    
    protected static space.catpaw.Controller.WebSocket.ControllerNotFound 
            webSocketControllerNotFound = new 
            space.catpaw.Controller.WebSocket.ControllerNotFound();

    
    protected static space.catpaw.Controller.Http.Get get = new space.catpaw.Controller.Http.Get();
 
    protected static space.catpaw.Controller.Http.Set set = new space.catpaw.Controller.Http.Set();

    protected static space.catpaw.Controller.Http.Isset isset = new space.catpaw.Controller.Http.Isset();
    
    protected static space.catpaw.Controller.Http.Unset unset = new space.catpaw.Controller.Http.Unset();
