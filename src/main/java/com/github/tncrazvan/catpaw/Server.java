...
public class Server {
    ...
    public static JsonObject readAsJsonObject(StringBuilder string){
        return Server.JSONPARSER.parse(string.toString()).getAsJsonObject();
    }
    public static JsonObject toJsonObject(StringBuilder string){
        return readAsJsonObject(string);
    }
    
    public static JsonArray readAsJsonArray(StringBuilder string){
        return Server.JSONPARSER.parse(string.toString()).getAsJsonArray();
    }
    public static JsonArray toJsonArray(StringBuilder string){
        return readAsJsonArray(string);
    }
    ...
    public static String atob(String value){
        try {
            return new String(Server.BASE64_DECODER.decode(value.getBytes(charset)),charset);
    ...
    public static byte[] atobByte(String value){
        try {
            return Server.BASE64_DECODER.decode(value.getBytes(charset));
        } catch (UnsupportedEncodingException ex) {
            logger.log(Level.WARNING,null,ex);
        }
        return null;
